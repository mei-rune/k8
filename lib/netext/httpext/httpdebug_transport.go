...
//  - https://github.com/runner-mei/k8/issues/986
//  - https://github.com/runner-mei/k8/issues/1042
//  - https://github.com/runner-mei/k8/issues/774
...
func (t httpDebugTransport) debugRequest(req *http.Request) {
	...
	if err != nil {
		t.logger.Fatal("debugRequest", log.Error(err)) //TODO: fix...
	}
	fmt.Printf("Request:\n%s\n", dump) //TODO: fix...
}
...
func (t httpDebugTransport) debugResponse(res *http.Response) {
	if res != nil {
		...
		if err != nil {
			t.logger.Fatal("debugResponse", log.Error(err)) //TODO: fix...
		}
		fmt.Printf("Response:\n%s\n", dump) //TODO: fix...
	}
}
