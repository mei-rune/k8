...
func (*K8) Fail(msg string) (goja.Value, error) {
	return goja.Undefined(), errors.New(msg)
}

func (*K8) Sleep(ctx context.Context, secs float64) {
...
func (*K8) RandomSeed(ctx context.Context, seed int64) {
...
// func (*K8) Group(ctx context.Context, name string, fn goja.Callable) (goja.Value, error) {
...
// func (*K8) Check(ctx context.Context, arg0, checks goja.Value, extras ...goja.Value) (bool, error) {
// 	state := lib.GetState(ctx)
// 	if state == nil {
